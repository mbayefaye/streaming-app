...
const createSendToken = (user, statusCode, res) => {
  ...
  //remove the passsword from output
...
exports.signup = catchAsync(async (req, res, next) => {
  ...
  //send a token along with new user
...
exports.protect = catchAsync(async (req, res, next) => {
  ...
  //gran access to protected  routes
...
exports.forgotPassword = catchAsync(async (req, res, next) => {
  ...
  const message = `Forgot your password? submit  a patch request with your new passord and passwordConfirm to:${resetURL} if you didn't forget your password ,please ignore it `;
  try {
    ...
    await user.save({ validateBeforeSave: false });
    return next(
      new AppError("There was an eror sending the email .try again", 500),
    );
  }
});
...
exports.confirmEmail = catchAsync((req, res, next) => {});
